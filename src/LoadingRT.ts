...
export default class LoadingRT extends LoadingRTBase {
    onAwake(): void {
        Laya.loader.load(
            //先加载本场景要用的
            ["resources/UI/progress.png", "resources/UI/progress$bar.png"]
        ).then(() => {
            let resArr: Array<any> = [
                ...
                "resources/UI/3.jpg",
                "resources/UI/4.jpg",
                "resources/UI/Drop.png",

                // "resources/audio/44.m4a",
                // "resources/audio/48.m4a",
                // "resources/audio/49.m4a",
                // "resources/audio/51.m4a",
                // "resources/audio/55.m4a",
                // "resources/audio/56.m4a",
                // "resources/audio/BGM.m4a",
                ...
                { url: "scenes/MainGame.ls", type: Laya.Loader.HIERARCHY },
                ...
                { url: "prefab/DropItem.lh", type: Laya.Loader.HIERARCHY },
                ...
                // { url: "resources/audio/44.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/48.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/49.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/51.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/55.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/56.m4a", type: Laya.Loader.BUFFER },
                // { url: "resources/audio/BGM.m4a", type: Laya.Loader.BUFFER },
            ...
            Laya.loader.load(resArr, null, Laya.Handler.create(this, this.onLoading, null, false)).then(() => {
                ...
                // Laya.Scene.open("scenes/MainGame.ls"); //不要使用Laya.Scene.open("./Scenes/Index.ls");
