(function () {
    let config = JSON.parse(`{"resolution":{"designWidth":1170,"designHeight":2168,"backgroundColor":"rgba(253, 255, 252, 1)","scaleMode":"fixedheight","alignV":"top","alignH":"left","screenMode":"none"},"3D":{"lightClusterCount":{"x":12,"y":12,"z":12},"enableDynamicBatch":true,"defaultPhysicsMemory":16,"enableUniformBufferObject":true,"pixelRatio":1,"enableMultiLight":true,"maxLightCount":32,"maxMorphTargetCount":32},"physics2D":{"gravity":{"y":9.8,"x":0},"allowSleeping":true,"velocityIterations":8,"positionIterations":3,"pixelRatio":50,"debugDraw":false,"drawShape":true,"drawJoint":true,"drawAABB":false,"drawCenterOfMass":false},"splash":{"fit":"center","enabled":true,"duration":1},"2D":{"FPS":60,"isAntialias":true,"useRetinalCanvas":false,"isAlpha":false,"webGL2D_MeshAllocMaxMem":true,"defaultFont":"SimSun","defaultFontSize":20},"physics3D":{"fixedTimeStep":0.016666666666666666,"maxSubSteps":1,"enableCCD":false,"ccdThreshold":0.0001,"ccdSphereRadius":0.0001},"physics3dModule":"laya.bullet","physics2dModule":"laya.box2D","spineVersion":"3.8","stat":false,"vConsole":false,"alertGlobalError":false,"startupScene":"Loading.ls","pkgs":[{"path":""}]}`);
